...
const links = [
  { to: "/recruteur/communaute", label: "Communauté", icon: FaUsers },
  { to: "/recruteur/dashboard", label: "Tableau de bord", icon: FaHouse },
  { to: "/recruteur/campagne", label: "Campagne", icon: FaBullhorn },
  { to: "/recruteur/offres", label: "Offres d'emploi", icon: FaBriefcase },
  { to: "/recruteur/decouvrir", label: "Découvrir", icon: FaCompass },
  { to: "/recruteur/services", label: "Services", icon: FaStore },
  { to: "/recruteur/messages", label: "Messages", icon: FaMessage },
];

function RecruteurSidebar() {
  return (
      ...
      <div className="mx-3 mb-4 pt-3 border-t border-gray-100">
        ...
        <div className="flex items-center gap-2 px-1 py-1">
          ...
          <div className="leading-tight">
            <p className="text-[13px] font-medium text-gray-900">Recruteur</p>
            <p className="text-[11px] text-gray-400">
              Publier des offres en tan...
            </p>
          </div>
        </div>
      </div>
...
export default RecruteurSidebar;
